...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        sessionType: {
            ...
            simple: 'Simples',
            simpleDesc: 'Executar no diretório atual',
            worktree: 'Worktree',
            worktreeDesc: 'Branch git isolado — alterações não afetam o principal',
            comingSoon: 'Em breve',
        },
        worktree: {
    ...
    settingsVoice: {
        ...
        progressUpdatesTitle: 'Atualizações de progresso',
        progressUpdatesDescription: 'Quando ativado, o assistente de voz resumirá periodicamente o que o agente está fazendo enquanto trabalha.',
        progressUpdatesEnabled: 'Atualizações automáticas',
    ...
    voiceMessage: {
        ...
        recording: 'Gravando',
        sending: 'Enviando mensagem de voz...',
        sent: 'Mensagem de voz enviada',
        failed: 'Falha ao enviar mensagem de voz',
        tapToRecord: 'Mantenha pressionado para mensagem de voz',
    ...
    notifications: {
        ...
        permissionQuestion: 'Tem uma pergunta para você',
        permissionPlanReview: 'Plano pronto para revisão',
        morePermissions: ({ count }: { count: number }) => `+${count} mais pendentes`,
    ...
    machine: {
        ...
        sessionMemoryTotal: 'Memória das sessões',
        lowMemoryWarning: 'Pouca memória',
        lowMemoryHint: 'A RAM livre está abaixo de 1 GB. Considere parar as sessões inativas.',
        recentlyClosed: 'Fechadas recentemente',
        archivedIdle: 'Tempo limite de inatividade',
        archivedManual: 'Parada manualmente',
        archivedCrash: 'Encerrada',
        archivedOrphan: 'Limpeza de órfãs',
        archivedOrphanSweep: 'Orphan cleanup (sweep)',
        worktrees: {
            title: 'Worktrees',
            deleteConfirm: 'Excluir este worktree?',
            deleteWarning: 'Uma sessão ativa está usando este worktree. Pare a sessão primeiro.',
        },
    },
    ...
    claude: {
        ...
        permissions: {
            ...
            sendFeedback: 'Enviar',
            feedbackPlaceholder: 'Diga ao Claude por quê...',
        }
    },
    ...
    permissions: {
        ...
        forLocalSettings: 'configurações locais do projeto',
