...
export const it: TranslationStructure = {
    ...
    newSession: {
        ...
        sessionType: {
            ...
            simple: 'Semplice',
            simpleDesc: 'Esegui nella directory corrente',
            worktree: 'Worktree',
            worktreeDesc: 'Branch git isolato — le modifiche non influenzano il principale',
    ...
    settingsVoice: {
        ...
        progressUpdatesTitle: 'Aggiornamenti di avanzamento',
        progressUpdatesDescription: 'Quando attivato, l\'assistente vocale riassumerà periodicamente ciò che l\'agente sta facendo mentre lavora.',
        progressUpdatesEnabled: 'Aggiornamenti automatici',
        progressUpdatesEnabledSubtitle: 'Aggiornamenti vocali durante le sessioni attive',
        progressInterval: 'Intervallo di aggiornamento',
        progressIntervalValue: ({ seconds }: { seconds: number }) => `${seconds}s`,

        // Voice personalization
        personalizationTitle: 'Personalizzazione',
        personalizationDescription: 'Personalizza il tuo assistente vocale. Queste impostazioni si applicano sia alle sessioni vocali in diretta che ai messaggi vocali.',
        assistantName: 'Nome dell\'assistente',
        assistantNamePlaceholder: 'Happy',
        assistantNameSubtitle: 'Nome usato nelle presentazioni e nei saluti',
        assistantBio: 'Su di te',
        assistantBioPlaceholder: 'Racconta all\'assistente di te...',
        assistantBioSubtitle: 'Contesto personale per risposte più pertinenti',
        assistantSetup: 'La tua configurazione CC',
        assistantSetupPlaceholder: 'Descrivi la tua configurazione di Claude Code...',
        assistantSetupSubtitle: 'Strumenti, flussi di lavoro e casi d\'uso comuni',
    },

    voiceMessage: {
        slideToCancel: 'Scorri per annullare',
        recording: 'Registrazione',
        sending: 'Invio messaggio vocale...',
        sent: 'Messaggio vocale inviato',
        failed: 'Invio messaggio vocale fallito',
        tapToRecord: 'Tieni premuto per messaggio vocale',
    ...
    notifications: {
        ...
        morePermissions: ({ count }: { count: number }) => `+${count} altri in attesa`,
    ...
    machine: {
        ...
        sessionMemoryTotal: 'Memoria sessioni',
        lowMemoryWarning: 'Poca memoria',
        lowMemoryHint: 'La RAM libera è inferiore a 1 GB. Considera di interrompere le sessioni inattive.',
        recentlyClosed: 'Chiuse di recente',
        archivedIdle: 'Timeout inattività',
        archivedManual: 'Fermata manualmente',
        archivedCrash: 'Terminata',
        archivedOrphan: 'Pulizia orfani',
        archivedOrphanSweep: 'Orphan cleanup (sweep)',
        worktrees: {
            title: 'Worktrees',
            deleteConfirm: 'Eliminare questo worktree?',
            deleteWarning: 'Una sessione attiva sta usando questo worktree. Ferma prima la sessione.',
        },
    },
    ...
    claude: {
        ...
        permissions: {
            ...
            sendFeedback: 'Invia',
            feedbackPlaceholder: 'Spiega a Claude perché...',
        }
    },
    ...
    permissions: {
        ...
        forLocalSettings: 'impostazioni locali del progetto',
