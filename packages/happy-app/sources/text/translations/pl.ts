...
export const pl: TranslationStructure = {
    ...
    newSession: {
        ...
        sessionType: {
            title: 'Typ sesji',
            simple: 'Prosta',
            simpleDesc: 'Uruchom w bieżącym katalogu',
            worktree: 'Worktree',
            worktreeDesc: 'Izolowana gałąź git — zmiany nie wpływają na główną',
    ...
    logSteps: {
        ...
        daysAgo: ({ count }: { count: number }) => `${count} dn. temu`,
    },
    ...
    settingsVoice: {
        ...
        progressUpdatesTitle: 'Aktualizacje postępu',
        progressUpdatesDescription: 'Po włączeniu asystent głosowy będzie okresowo podsumowywał, co robi agent podczas pracy.',
        progressUpdatesEnabled: 'Automatyczne aktualizacje',
    ...
    voiceMessage: {
        ...
        sending: 'Wysyłanie wiadomości głosowej...',
        sent: 'Wiadomość głosowa wysłana',
        failed: 'Wysyłanie wiadomości głosowej nie powiodło się',
        tapToRecord: 'Przytrzymaj, aby nagrać wiadomość głosową',
    ...
    machine: {
        ...
        sessionMemoryTotal: 'Pamięć sesji',
        lowMemoryWarning: 'Mało pamięci',
        lowMemoryHint: 'Wolna pamięć RAM poniżej 1 GB. Rozważ zatrzymanie nieaktywnych sesji.',
        recentlyClosed: 'Ostatnio zamknięte',
        archivedIdle: 'Limit czasu bezczynności',
        archivedManual: 'Zatrzymano ręcznie',
        archivedCrash: 'Zakończono',
        archivedOrphan: 'Czyszczenie osieroconych',
        archivedOrphanSweep: 'Orphan cleanup (sweep)',
        worktrees: {
            title: 'Worktrees',
            deleteConfirm: 'Usunąć ten worktree?',
            deleteWarning: 'Aktywna sesja używa tego worktree. Najpierw zatrzymaj sesję.',
        },
    },
