...
export const SettingsSchema = z.object({
    ...
    voiceAssistantName: z.string().nullable().describe('Custom name for the voice assistant (null for default "Happy")'),
    voiceAssistantBio: z.string().nullable().describe('Personal context about the user injected into the voice assistant system prompt'),
    voiceAssistantSetup: z.string().nullable().describe('Description of the user CC setup, tools, and workflows for voice assistant context'),
    ...
    lastUsedAutoApproveTools: z.boolean().nullable().describe('Last used auto-approve tools toggle for new sessions'),
...
export const settingsDefaults: Settings = {
    ...
    voiceAssistantBio: null,
    voiceAssistantSetup: null,
    preferredLanguage: null,
    recentMachinePaths: [],
    lastUsedAgent: null,
    lastUsedPermissionMode: null,
    lastUsedModelMode: null,
    lastUsedAutoApproveTools: false,
