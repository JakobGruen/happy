...
export const LocalSettingsSchema = z.object({
    ...
    // Anthropic voice pipeline API key (device-local, never synced)
    anthropicVoiceApiKey: z.string().nullable().describe('Anthropic API key for voice pipeline (stored on-device only)'),
